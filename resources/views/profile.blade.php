                      ...
                      <div class="container mt-3">
                            ...
                            <!-- end subject -->
                                    ...
                                    <div class="con bg-info text-center navrad pr-3 pl-3 ml-3 mt-1">
                                            <a style="text-decoration:none" href="#"><img src="images/profile.png"class="inage mt-2" alt="no" width="40px" height="40px">
                     ...
                     <div class="col-lg-12 col-md-6 bg-light conrad">
                            <form action="/examples/actions/confirmation.php" method="post">
                                ...
                                <div class="form-group mt-4">
                                        <input type="text" class="form-control" value="Abdul Rafay Javed" readonly>
                                    </div>      
                                <div class="form-group">
                                    <input type="emal" class="form-control" value="rafayabdul252@gmail.com" readonly>
                                </div>
                                <div class="form-group">
