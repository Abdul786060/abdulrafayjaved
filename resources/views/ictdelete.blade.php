                            ...
                            <!-- end subject -->
                                       <!-- home -->
                                        ...
                                        <div class="con bg-info text-center navrad pr-3 pl-3 ml-3 mt-1">
                                                <a style="text-decoration:none" href="#"><img src="images/delete.png"class="inage mt-2" alt="no" width="40px" height="40px">
                                                    <p style="color: white;">Delete</p></a>
                      ...
                      <!-- end PROFILE-->
                        ...
                        <div class="row">
                         <div class="col-lg-12 col-md-6 bg-info text-center uprad">
                            ...
                            <h5 class="mt-2 mb-2" style="color: white;"><b>Delete Your Record</b></h5>
